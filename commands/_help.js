...
async(Void, citel, text) => {
 ...
 let arr = [];
        ...
        if (!cmd) return await citel.reply("*😔No Such commands, if you wish to add a command message us at 2349070616688*");
